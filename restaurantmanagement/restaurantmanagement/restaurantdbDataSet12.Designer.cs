...
namespace restaurantmanagement {
    ...
    public partial class restaurantdbDataSet12 : global::System.Data.DataSet {
        ...
        public partial class registrationDataTable : global::System.Data.TypedTableBase<registrationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public registrationRow AddregistrationRow(int Id, string Name, string Address, int Contact, string Designation, decimal Salary) {
        ...
        public partial class registrationRow : global::System.Data.DataRow {
            ...
            public int Contact {
                get {
                    return ((int)(this[this.tableregistration.ContactColumn]));
                }
                set {
            ...
            public string Designation {
                get {
                    return ((string)(this[this.tableregistration.DesignationColumn]));
                }
                set {
                    this[this.tableregistration.DesignationColumn] = value;
                }
            }
            ...
            public decimal Salary {
                get {
                    return ((decimal)(this[this.tableregistration.SalaryColumn]));
                }
                set {
                    this[this.tableregistration.SalaryColumn] = value;
                }
            }
        }
...
namespace restaurantmanagement.restaurantdbDataSet12TableAdapters {
    ...
    public partial class registrationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[registration] WHERE (([Id] = @Original_Id) AND ([Name] = @Orig" +
                "inal_Name) AND ([Contact] = @Original_Contact) AND ([Designation] = @Original_De" +
                "signation) AND ([Salary] = @Original_Salary))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[registration] ([Id], [Name], [Address], [Contact], [Designatio" +
                "n], [Salary]) VALUES (@Id, @Name, @Address, @Contact, @Designation, @Salary);\r\nS" +
                "ELECT Id, Name, Address, Contact, Designation, Salary FROM registration WHERE (I" +
                "d = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[registration] SET [Id] = @Id, [Name] = @Name, [Address] = @Address, [Contact] = @Contact, [Designation] = @Designation, [Salary] = @Salary WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Contact] = @Original_Contact) AND ([Designation] = @Original_Designation) AND ([Salary] = @Original_Salary));
SELECT Id, Name, Address, Contact, Designation, Salary FROM registration WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Address, Contact, Designation, Salary FROM dbo.registration";
        ...
        public virtual int Fill(restaurantdbDataSet12.registrationDataTable dataTable) {
        ...
        public virtual restaurantdbDataSet12.registrationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            restaurantdbDataSet12.registrationDataTable dataTable = new restaurantdbDataSet12.registrationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(restaurantdbDataSet12.registrationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Contact, string Original_Designation, decimal Original_Salary) {
        ...
        public virtual int Insert(int Id, string Name, string Address, int Contact, string Designation, decimal Salary) {
        ...
        public virtual int Update(int Id, string Name, string Address, int Contact, string Designation, decimal Salary, int Original_Id, string Original_Name, int Original_Contact, string Original_Designation, decimal Original_Salary) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address, int Contact, string Designation, decimal Salary, int Original_Id, string Original_Name, int Original_Contact, string Original_Designation, decimal Original_Salary) {
            return this.Update(Original_Id, Name, Address, Contact, Designation, Salary, Original_Id, Original_Name, Original_Contact, Original_Designation, Original_Salary);
        }
    }
